---
name: Bug Report
about: Create a report to help us improve Handy API
title: "[BUG] "
labels: ["bug"]
assignees: ""
---
...
**Please search [existing Handy API issues](https://github.com/MakinaX/Handy-Api/issues) to avoid duplicates.** Your bug may already be reported; checking first helps the maintainer focus on confirmed problems.
